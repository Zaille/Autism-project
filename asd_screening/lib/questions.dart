...
import 'package:asdscreening/results.dart';
...
class QuestionState extends State<QuestionsPage> {
  ...
  Widget build(BuildContext context) {
    List<String> question = widget.questions[questionIndex].split("\n");
    return Scaffold(
      body: Column(
              ...
              nextFunction: () {
                if (selected == null)
                  ...
                  if (questionIndex == 19) {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => ResultsPage(responses: this.responses, score: this.score)),
                    );
                  }
                  else {
                    setState(() {
